...
var Stars = function Stars(_ref) {
  ...
  return __jsx("a", {
    href: "https://github.com/".concat(full_name, "/stargazers"),
    className: "d-ib",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
...
var ItemAbout = function ItemAbout(_ref) {
  var full_name = _ref.full_name,
      stargazers_count = _ref.stargazers_count,
      language = _ref.language,
      license = _ref.license,
      updated_at = _ref.updated_at,
      issues_need_help = _ref.issues_need_help;
  return __jsx("div", {
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./types */ "./store/repoSearch/types.ts");
/* harmony import */ var utils_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! utils/api */ "./utils/api/index.ts");
...
var Actions = {
  setSearchResult: function setSearchResult(searchResult) {
    return {
      type: _types__WEBPACK_IMPORTED_MODULE_2__["SET_SEARCH_RESULT"],
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(utils_api__WEBPACK_IMPORTED_MODULE_3__["gitApi"].searchRepository(searchQuery));
            ...
            case 3:
              ...
              _context.next = 8;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(addTopics(items));

            case 8:
              items = _context.sent;
              _context.next = 11;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(addIssuesNeedHelp(items));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(utils_api__WEBPACK_IMPORTED_MODULE_3__["gitApi"].getRepositoryTopics(item.owner, item.name));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(utils_api__WEBPACK_IMPORTED_MODULE_3__["gitApi"].getRepositoryIssuesNeedHelp(item.owner, item.name));
...
var SET_SEARCH_RESULT = "SET_REPO_SEARCH_RESULT";
...
/* harmony import */ var utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! utils */ "./utils/index.ts");
/* harmony import */ var core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core */ "./core/index.ts");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  searchRepository: function searchRepository() {
    var searchRequest,
        _args = arguments;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function searchRepository$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            searchRequest = _args.length > 0 && _args[0] !== undefined ? _args[0] : {};
            _context.next = 3;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(core__WEBPACK_IMPORTED_MODULE_2__["axiosGitApi"].get("/search/repositories".concat(Object(utils__WEBPACK_IMPORTED_MODULE_1__["getRequestParser"])(searchRequest))).then(function (response) {
  ...
  getRepositoryTopics: function getRepositoryTopics(owner, repo) {
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function getRepositoryTopics$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(core__WEBPACK_IMPORTED_MODULE_2__["axiosGitApi"].get("/repos/".concat(owner, "/").concat(repo, "/topics")).then(function (response) {
              if (response.status !== 200) {
                return Promise.reject(response.status);
              }
  ...
  getRepositoryIssuesNeedHelp: function getRepositoryIssuesNeedHelp(owner, repo) {
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function getRepositoryIssuesNeedHelp$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(core__WEBPACK_IMPORTED_MODULE_2__["axiosGitApi"].get("/repos/".concat(owner, "/").concat(repo, "/issues").concat(Object(utils__WEBPACK_IMPORTED_MODULE_1__["getRequestParser"])({
              labels: "help wanted"
...
var getRequestParser = function getRequestParser(searchRequest) {
  var searchString = "?";

  for (var _i = 0, _Object$entries = Object.entries(searchRequest); _i < _Object$entries.length; _i++) {
    ...
    searchString += "".concat(key, "=").concat(value.toString().replace(" ", "+"), "&");
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var kFormatter = function kFormatter(num, fixed) {
